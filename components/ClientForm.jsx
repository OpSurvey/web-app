...
export default function ClientForm() {
  ...
  const onSubmit = async (data) => {
    ...
    let result = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/client`, {
      method: "POST",
      headers: {
  ...
  return (
    <>
      <NavDashboard />
      <main className="container mx-auto py-6 lg:px-44 sm:px-6 min-h-screen flex justify-center items-center">
        <form
