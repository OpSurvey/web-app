  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="bg-zinc-900 px-6 py-3">
      ...
      <label
        ...
        />
        {errors.firstName?.type === "required" && <span className="text-red-400 ">El nombre es requerido</span>}
        {errors.firstName?.type === "minLength" && <span className="text-red-400 ">Largo mínimo del nombre son 3 caracteres</span>}
      ...
      <label
        ...
        />
        {errors.lastName?.type === "required" && <span className="text-red-400 ">El apellido es requerido</span>}
        {errors.lastName?.type === "minLength" && <span className="text-red-400 ">Largo mínimo del apellido son 3 caracteres</span>}
      ...
      <div className="relative z-0 mb-6 w-full group">
        ...
        />
        {errors.phone?.type === "required" && <span className="text-red-400 ">El teléfono es requerido</span>}
        {errors.phone?.type === "minLength" && <span className="text-red-400 ">Largo mínimo del teléfono son 10 caracteres</span>}
      </div>
      ...
      <div className="relative z-0 mb-6 w-full group">
        ...
        <div className="relative z-0 mb-6 w-full group">
          ...
          {errors.businessName?.type === "minLength" &&
            <span className="text-red-400 ">El nombre del negocio es requerido</span>}
        </div>
      </div>
      <div className="grid md:grid-cols-2 md:gap-6">
        <div className="relative z-0 mb-6 w-full group">
          ...
          />
          {errors.RFC?.type === "minLength" && <span className="text-red-400 ">Largo mínimo del RFC son 12 caracteres</span>}
          {errors.RFC?.type === "maxLength" && <span className="text-red-400 ">Largo máximo del RFC son 13 caracteres</span>}
