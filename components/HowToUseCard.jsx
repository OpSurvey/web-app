...
export default function HowToUseCard(props){
    return(
        <div href="#" className= {`"flex items-center flex-col mb-3  rounded-lg md:flex md:${props.direction} w-full"`} >
            <Image className="object-cover w-full h-auto md:h-36 md:w-36 md:rounded-none md:rounded-l-lg md:m-2" src="https://portolapilot.com/wp-content/uploads/2018/12/300x300.png" alt=""/>
