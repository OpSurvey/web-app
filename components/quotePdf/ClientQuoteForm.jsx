...
export default function Search(props) {
  ...
  console.log('recipesFilter',recipesFilter.price)
...
return (
  <div className="w-72">
                ...
                >
                  {({ selected, active }) => (
                    ...
                    <>
                      ...
                      {selected ? (
                        <span
                        onClick={setRecipesFilter(recipe)}
    ...
    <Combobox value ={recipesFilter.price}>
      <Combobox.Input value ={recipesFilter.price}/>
    </Combobox>
  </div>
  )
}